...
<style>
	...
	/* the map column is much narrower here than on desktop, so the
	   centered/half-width search box collides with the masthead's title —
	   go full-width above it instead, same fix mobile already uses. */
